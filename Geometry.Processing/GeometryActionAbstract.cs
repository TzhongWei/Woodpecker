...
namespace Woodpecker.Animation.Geometry.Processing
{
    public abstract class GeometryActionAbstract
    {
        ...
        public abstract bool TryApply(GeometryBase input, double currentT, out GeometryBase output);
    ...
    public abstract class TransformTSAction : GeometryActionAbstract
    {
        ...
        public abstract Transform GetTransform(double NormalT);
        public override bool TryApply(GeometryBase input, double currentT, out GeometryBase output)
        {
