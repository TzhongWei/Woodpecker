...
namespace Woodpecker.Animation.GHComponents
{
    ...
    /// </summary>
    [Obsolete]
    public class GH_DisplayGeometry_Old : GH_Component
    {
        public override GH_Exposure Exposure => GH_Exposure.hidden;
        public GH_DisplayGeometry_Old() : base("Display Geometry", "DispGeo", "Display geometry in the viewport with custom color and width. t provides a fade effect by time.", "Woodpecker", "Display")
        {
        }
