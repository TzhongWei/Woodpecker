...
namespace Woodpecker.Animation.GHComponents
{
    ...
    /// </summary>
    [Obsolete]
    public class GH_DisplayGeometryCols_Old : GH_Component
    {
        public override GH_Exposure Exposure => GH_Exposure.hidden;
        public GH_DisplayGeometryCols_Old() : base("Display Geometry Cols", "DispGeoCols", "Display geometry with custom colors in the viewport. Based on the pointer_t, the colors will be interpolated.", "Woodpecker", "Display")
        {
        }
