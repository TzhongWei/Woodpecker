...
{
    public class GH_DisplayDashCurveVector : GH_DisplayGeometryAbstract
    {
        public GH_DisplayDashCurveVector() : base("Vector Dash Curve Display", "VDCD", "Display vector on a dash curve with a curved arrow")
        {
        ...
        public override Guid ComponentGuid => new Guid("154f4bfd-7f37-44bf-ab27-70dff8efbce9");
        protected override System.Drawing.Bitmap Icon => Properties.Resources.GH_Display_Dash_Vect;
