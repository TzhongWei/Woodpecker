...
namespace Woodpecker.Animation.GHComponents
{
    public class GH_AnimationSetting : GH_Component
    {
        ...
        public GH_AnimationSetting():base("Animation Setting", "ASetting", "", "Woodpecker", "Util"){}
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Output Name", "Name", "", GH_ParamAccess.item, "Result.mov");
            pManager.AddTextParameter("Frame Prefix", "Prefix", "", GH_ParamAccess.item, "Frame_");
            pManager.AddIntegerParameter("Frame Digits", "Digits", "", GH_ParamAccess.item, 5);
            pManager.AddNumberParameter("Frame Duration", "Duration", "", GH_ParamAccess.item, 1.0 / 30.0);
            pManager.AddBooleanParameter("Overwrite", "Overwrite", "", GH_ParamAccess.item, true);
        }

        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            pManager.AddTextParameter("Animation Setting", "Setting", "", GH_ParamAccess.item);
        }
